...
class SavingServiceTest {
    ...
    void testGetMonthlySaving() {
        ...
        // When
        MonthlySaving actual = savingService.getMonthlySaving(CURRENT_USER_ID, year, month);
    ...
    void testUpdateMonthlySaving() {
        ...
        // When
        MonthlySaving actual = savingService.updateMonthlySaving(
            CURRENT_USER_ID,
            year,
            month,
            newAmount,
    ...
    void testDeleteMonthlySaving() {
        ...
        // When
        savingService.deleteMonthlySaving(CURRENT_USER_ID, year, month);
    ...
    void testGetSavingsByYear() {
        ...
        // When
        List<MonthlySaving> actual = savingService.getSavingsByYear(CURRENT_USER_ID, year);
